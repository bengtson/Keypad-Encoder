...
ifeq "$(wildcard nbproject/Makefile-local-TMasterTarget.mk)" "nbproject/Makefile-local-TMasterTarget.mk"
include nbproject/Makefile-local-TMasterTarget.mk
endif
endif
...
.build-conf:  ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-TMasterTarget.mk dist/${CND_CONF}/${IMAGE_TYPE}/Keypad_Prototype.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/_ext/1472/keypad.o: ../keypad.asm  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} dummy.d -e "${OBJECTDIR}/_ext/1472/keypad.err" $(SILENT) -rsi ${MP_CC_DIR}  -c ${MP_AS} $(MP_EXTRA_AS_PRE) -d__DEBUG -d__MPLAB_DEBUGGER_PK3=1 -q -p$(MP_PROCESSOR_OPTION) -u  -l\\\"${OBJECTDIR}/_ext/1472/keypad.lst\\\" -e\\\"${OBJECTDIR}/_ext/1472/keypad.err\\\" $(ASM_OPTIONS)-dmaster -w1   -o\\\"${OBJECTDIR}/_ext/1472/keypad.o\\\" \\\"../keypad.asm\\\" 
...
${OBJECTDIR}/_ext/1472/keypad.o: ../keypad.asm  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR}/_ext/1472 
	@${RM} ${OBJECTDIR}/_ext/1472/keypad.o.d 
	@${FIXDEPS} dummy.d -e "${OBJECTDIR}/_ext/1472/keypad.err" $(SILENT) -rsi ${MP_CC_DIR}  -c ${MP_AS} $(MP_EXTRA_AS_PRE) -q -p$(MP_PROCESSOR_OPTION) -u  -l\\\"${OBJECTDIR}/_ext/1472/keypad.lst\\\" -e\\\"${OBJECTDIR}/_ext/1472/keypad.err\\\" $(ASM_OPTIONS)-dmaster -w1   -o\\\"${OBJECTDIR}/_ext/1472/keypad.o\\\" \\\"../keypad.asm\\\" 
	@${DEP_GEN} -d "${OBJECTDIR}/_ext/1472/keypad.o"
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/TMasterTarget
	${RM} -r dist/TMasterTarget
